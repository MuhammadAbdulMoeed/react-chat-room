                ...
                */}
                ...
                <div className="uk-inline">
                    ...
                    <div data-uk-dropdown="mode: click; offset: 5; boundary: .top-bar; pos: bottom-right">
                        ...
                        {Config.demo &&
                        <div className="link" onClick={honeyside}>Honeyside <div className="icon"><FiExternalLink/>
                        </div></div>}
                        {Config.demo &&
                        <div className="link" onClick={codeCanyon}>CodeCanyon <div className="icon"><FiExternalLink/>
                        </div></div>}
                    </div>
                </div>
            </div>
